...
async function updateTokenMetadata(
  ...
  // file to buffer
  const buffer = fs.readFileSync("assets/TLSimge-download.jpg")

  // buffer to metaplex file
  const file = toMetaplexFile(buffer, "TLSimge-download.jpg")
...
async function main() {
  ...
  await updateTokenMetadata(
    ...
    user,
    "Try Token", // Token name - REPLACE THIS WITH YOURS
    "TRY",     // Token symbol - REPLACE THIS WITH YOURS
    "Stable Turkis lira" // Token description - REPLACE THIS WITH YOURS
  )
}
...
const tokenName = "TryToken"
const description = "Digital Turkish Lira"
const symbol = "Try"
const decimals = 2
const amount = 1
